...
## Dataset
- **Nguồn:** vnstock-db (`Quote(source="KBS")`)
...
*(Kết quả dưới đây là từ nghiên cứu ban đầu trên universe 10 mã — Ngày 5, cùng 248 quan sát chung. Cần chạy lại trên universe 30 mã để cập nhật bảng này — xem "Cách chạy".)*
